...
let epee_de_debutant = new item("Epee De D̩butant", 30, 0, 10, true)
...
let shop_arme = [new item("Epee De Noob", 10, 0, 1, true), new item("Epee Moins Noob", 20, 0, 5, true), new item("Epee De D̩butant", 30, 0, 10, true), new item("Epee De Fou", 60, 0, 20, true), new item("Epee De MJ", 100, 0, 1, false)]
...
let mainCharacter = function(name="None", level=1, life=10, weapon=new item("Epee De Noob", 10, 0, 1, true)) {
    ...
    this.txtAttack = function() {
        return this.name+" attaque avec " + this.weapon.name + " d̩gats : " + this.attack()[0] + " physique, " + this.attack()[1] + " magique"
    }
}
